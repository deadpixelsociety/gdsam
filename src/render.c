...
unsigned char _freq1data[80];
unsigned char _freq2data[80];
...
void Render()
{
    ...
    for(int j = 0; j < 80; j++) {
        _freq1data[j] = freq1data[j];
        _freq2data[j] = freq2data[j];
    }
...
do
{
    ...
    */
    ...
    do
    {
        frequency1[X] = _freq1data[Y];     // F1 frequency
        frequency2[X] = _freq2data[Y];     // F2 frequency
